      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_obat,a.jumlah_masuk,a.dari,b.kode_obat,b.nama_obat,b.satuan
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[dari]</td>
                      <td class='center' width='80'>
                      <div>
                          <a data-toggle='tooltip' data-placement='top' title='Hapus' class='btn btn-primary btn-sm' href='modules/obat-masuk/proses.php?act=delete&kode_transaksi=$data[kode_transaksi]'>
